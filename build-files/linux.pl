...
system("mv qgvdial-$qver/build-files/org.freedesktop.Telepathy.ConnectionManager.qgvtp.service.linux qgvdial-$qver/build-files/org.freedesktop.Telepathy.ConnectionManager.qgvtp.service");

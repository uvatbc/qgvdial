...
$cmd = "cd qgvdial-$qver/qgvdial/symbian & prep_s3_belle.bat";
print "$cmd\n";
system($cmd);
...
$cmd = "$enterdir & powershell cp qgvdial.sis $dest/qgvdial_s3_belle_$qver.sis & powershell cp unsigned_qgvdial.sis $dest/unsigned_qgvdial_s3_belle_$qver.sis & powershell cp qgvdial_installer.sis $dest/qgvdial_installer_s3_belle_$qver.sis";
print("$cmd\n");
system($cmd);

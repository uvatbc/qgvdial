...
$cmd = "cd $basedir ; mkdir -p bundle/qgvdial_10.1.0.4200 ; cp qgvdial.bar bundle/qgvdial_10.1.0.4200 ; cp build-files/qgvdial/bb10/release.xml bundle ; cd bundle ; zip -r -9 -v qgvdial .";
print "$cmd\n";
system($cmd);

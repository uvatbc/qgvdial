...
#include "SailfishPhoneFactory.h"
#include "IPhoneAccount.h"

IPhoneAccountFactory *
createPhoneAccountFactory(QObject *parent)
{
    return (new SailfishPhoneFactory(parent));
}//createPhoneAccountFactory

SailfishPhoneFactory::SailfishPhoneFactory(QObject *parent)
...
}//SailfishPhoneFactory::SailfishPhoneFactory

bool
SailfishPhoneFactory::identifyAll(AsyncTaskToken *task)
{
    ...
    return true;
}//SailfishPhoneFactory::identifyAll

void
SailfishPhoneFactory::completeIdentifyTask(int status)
{
    AsyncTaskToken *task = m_identifyTask;
    m_identifyTask = NULL;
    task->status = status;
    task->emitCompleted ();
}//SailfishPhoneFactory::completeIdentifyTask

void
SailfishPhoneFactory::onOnePhone(IPhoneAccount *p)
{
    m_accounts[p->id ()] = p;
}//SailfishPhoneFactory::onOnePhone

void
SailfishPhoneFactory::onTpIdentified()
{
